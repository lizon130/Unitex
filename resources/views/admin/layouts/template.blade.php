        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              {{-- <span class="app-brand-text demo menu-text fw-bolder ms-2">Unitex</span> --}}
              <a class="nav-brand" href="{{route('dashboard.index')}}"><img src="{{asset('home/img/core-img/unitex.png')}}" alt=""></a>
            </a>
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item @if(request()->routeIs('dashboard.index')) active @endif">
            ...
            <li class="menu-item @if(request()->routeIs('category.add')) active @endif">
              ...
              <li class="menu-item @if(request()->routeIs('subcategory.add')) active @endif">
              ...
              <li class="menu-item @if(request()->routeIs('subcategory.index')) active @endif">
              ...
              <li class="menu-item @if(request()->routeIs('product.add')) active @endif">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{asset('home/img/avatars/r1.png')}}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block">Masud Rana </span>
                            {{-- email - pass

                            email- masud.rana@gmail.com
                            pass- rana13579
